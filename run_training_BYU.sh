...
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=7,6 torchrun --nproc_per_node=2 --master_port=29500 src/transformer_reasoning/train/train_llama.py --num_params 900000 --orders 1 2 --num_layers 4 --relations 17 --N 10000 --resume_from_checkpoint --commit_hash_override ecb2fdc

TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=5,4 torchrun --nproc_per_node=2 --master_port=29501 src/transformer_reasoning/train/train_llama.py --num_params 1500000 --orders 1 2 --num_layers 4 --relations 17 --N 10000 --resume_from_checkpoint --commit_hash_override ecb2fdc
